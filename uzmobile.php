      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <div class="w3-progress-container w3-round-xlarge w3-small">
            <div class="w3-progressbar w3-round-xlarge w3-teal" style="width:100%">
...
<div align="center">
          <form action="Get" >
              ...
              <input type="text" name="ism" placeholder="ismni kiriting"><br><br>
              <input type="text" name="fam" placeholder="familiyani kiriting"><br><br>

              <input type="text" name="email" placeholder="email kiriting"><br><br>        
              Murojaatni jo'nating:<br><textarea name="txt"></textarea>
              
              <br><br>      
              
              <input type="submit" name="ok" value="jo'natish">
          </form>
          </div>
...
<!-- Mirrored from www.w3schools.com/w3css/tryit.asp?filename=tryw3css_templates_cv&stacked=h by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Nov 2016 00:34:10 GMT -->
</html> 
